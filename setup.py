...
def create_module(name, libraries):
    native_modules.append(Extension(
        ...
        library_dirs=[pharlap_lib_path],
        libraries=libraries + ['m']))
    pass

create_module('abso_bg', ['propagation', 'maths', 'iri2016', 'gfortran'])
create_module('dop_spread_eq', ['propagation', 'iri2016', 'iri2020', 'gfortran'])
create_module('ground_bs_loss', ['propagation', 'gfortran'])
create_module('ground_fs_loss', ['propagation', 'gfortran'])
create_module('igrf2007', ['maths', 'iri2007', 'gfortran'])
create_module('igrf2011', ['maths', 'iri2012', 'gfortran'])
create_module('igrf2016', ['maths', 'iri2016', 'gfortran'])
create_module('igrf2020', ['maths', 'iri2020', 'gfortran'])
create_module('iri2007', ['iri2007', 'gfortran'])
create_module('iri2012', ['iri2012', 'gfortran'])
create_module('iri2016', ['iri2016', 'gfortran'])
create_module('iri2020', ['iri2020', 'gfortran'])
create_module('irreg_strength', ['propagation', 'iri2016', 'iri2020', 'gfortran'])
create_module('nrlmsise00', ['maths', 'iri2016', 'gfortran'])
create_module('raytrace_2d', ['propagation', 'maths', 'gfortran', 'gomp'])
create_module('raytrace_2d_sp', ['propagation', 'maths', 'gfortran', 'gomp'])
create_module('raytrace_3d', ['propagation', 'maths', 'gfortran', 'gomp'])
create_module('raytrace_3d_sp', ['propagation', 'maths', 'gfortran', 'gomp'])
